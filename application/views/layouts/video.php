...
<link rel="stylesheet" href="/resource/css/jquery.tag-editor.css" />
<?php $rand = mt_rand();?>
...
<script type="text/javascript" src="/resource/scripts/jquery/jquery.caret.min.js?<?php echo $rand;?>"></script>
<script type="text/javascript" src="/resource/scripts/jquery/jquery.tag-editor.min.js?<?php echo $rand;?>"></script>
...
<script type="text/javascript" src="/resource/scripts/modules/video.js?<?php echo $rand;?>"></script>
<script type="text/javascript" src="/resource/scripts/jquery/json2.js?<?php echo $rand;?>"></script>
<script type="text/javascript" src="/resource/scripts/upload/js.cookie.js?<?php echo $rand;?>"></script>
</head>
<body>
