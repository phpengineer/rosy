...
class Log_Database extends Log_Writer {
	...
	protected $_table = 'gvs_log_crash';
	
	public function __construct() {
		$this->_connection = Kohana::$config->load("database.account.connection");
		$this->_charset = Kohana::$config->load("database.account.charset");
	}
